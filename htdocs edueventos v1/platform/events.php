                    ...
                    <?php foreach ($events as $event): ?>
                        <tr>
                            ...
                            <td class="action-icons">
                                <img src="<?= BASE_URL ?>images/view_icon.png" alt="Ver Detalles" title="Ver Detalles" onclick="alert('Ver detalles del evento <?= htmlspecialchars($event['evento_titulo']) ?>');">
                                <img src="<?= BASE_URL ?>images/edit_icon.png" alt="Editar" title="Editar Evento" onclick="openEditEventModal(<?= htmlspecialchars(json_encode($event)) ?>);">
                                <img src="<?= BASE_URL ?>images/delete_icon.png" alt="Eliminar" title="Eliminar Evento" onclick="confirmDelete(<?= $event['evento_id'] ?>, '<?= htmlspecialchars($event['evento_titulo']) ?>');">
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
