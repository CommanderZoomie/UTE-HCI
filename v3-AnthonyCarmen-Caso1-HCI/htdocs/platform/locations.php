                    ...
                    <?php foreach ($locations as $location): ?>
                        <tr>
                            ...
                            <td class="action-icons">
                                <img src="<?= BASE_URL ?>images/view_icon2.jpg" alt="Ver" title="Ver Detalles" onclick="alert('Ver detalles de la ubicación: <?= htmlspecialchars($location['ubicacion_titulo']) ?>');" style="width: 30px; height: 30px;">
