...
<section class="dashboard-section">
    ...
    <div class="dashboard-actions">
        ...
        <div class="action-item">
            <img src="<?= BASE_URL ?>images/view_icon2.jpg" alt="Ver Información Adicional">
            <p><strong>Ver Información Adicional</strong></p>
        </div>
        <div class="action-item">
            <img src="<?= BASE_URL ?>images/edit_icon.jpg" alt="Editar Información">
            <p><strong>Editar Información</strong></p>
        </div>
        <div class="action-item">
            <img src="<?= BASE_URL ?>images/delete_icon.jpg" alt="Eliminar fila">
            <p><strong>Eliminar fila</strong> de la lista</p>
        </div>
        <div class="action-item">
            <img src="<?= BASE_URL ?>images/add_icon2.png" alt="Agregar Nuevo">
