                    ...
                    <?php foreach ($events as $event): ?>
                        <tr>
                            ...
                            <td class="action-icons">
                                <img src="<?= BASE_URL ?>images/view_icon2.jpg" alt="Ver Detalles" title="Ver Detalles" onclick="alert('Ver detalles del evento <?= htmlspecialchars($event['evento_titulo']) ?>');" style="width: 30px; height: 30px;">
