                    ...
                    <?php foreach ($contacts as $contact): ?>
                        <tr>
                            ...
                            <td class="action-icons">
                                <img src="<?= BASE_URL ?>images/view_icon2.jpg" alt="Ver" title="Ver Detalles" onclick="alert('Ver detalles del contacto: <?= htmlspecialchars($contact['contactos_nombres'] . ' ' . $contact['contactos_apellidos']) ?>');"style="width: 30px; height: 30px;">
